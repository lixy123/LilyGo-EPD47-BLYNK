# LilyGo-EPD47-BLYNK
利用BLYNK 技术打造个人专属的信息显示专用机

   信息无处不在，比如在我们逛商场，坐地铁，电梯内，看手机视频，办公室，餐厅被动听他人聊天等。无疑，这些信息大半都是无用的垃圾信息。几乎对我们没有用处。
我设计打造了一个专有的信息接收机. 配置并接收专属个人的信息文字，放在个人空间，例如家里，办公室等，是一件很有意义和价值的东东。
以目前的技术，此功能做成手机APP并没有什么困难，但手机承载功能太多，不是一个好的载体。

   技术方案及功能
        功能上分为消息显示，消息发送。 目前较经济的方式是用 blynk协议来让消息无阻碍传送. 此协议将内网，外网完全打通。 开放的协议， 甚至接受HTTP协议，可以很容易和一些消息推送云服务集成.

   硬件清单
         墨水屏, 蓝牙唤醒器,ESP32信息发送器
         A.墨水屏的要求是大小合适，便于摆放在随处可见的信息，例如门上，冰箱上，床头。 最好不需要频繁充电. 
         B.消息发送器可以是手机，云服务器,树莓派等。特别一提的是IFTTT,它的全称是 If this then that，意思是“如果这样，那么就那样",  可以将信息在合适时机发送给你，例如天气异常变化了，家里的门在不正常时间打开了，到了该起床或上班的时间, 指定发封邮件，短信息，手机提醒，甚至提醒到墨水屏，让墨水屏读出文字等。
