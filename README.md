...
<b>二.主要硬件清单</b><br/>
   1.lilygo-epd47*1 + HC08 *1 + 电池*1 (显示终端)<br/>
     指标:<br/>
       休眠时整体电流<1ma <br/>
       唤醒时间<2秒<br/>
       显示文字用时 <3秒<br/>
...
注： <br/>
  手机APP不需要与esp32在同一个局域网内。<br/>
  LilyGo-EPD47墨水屏与esp32是蓝牙通讯,距离在2-5内<br/>
  常供电的esp32电流约40-80ma左右<br/>
  LilyGo-EPD47墨水屏平时休眠时电流约0.5ma左右(估算)<br/>
